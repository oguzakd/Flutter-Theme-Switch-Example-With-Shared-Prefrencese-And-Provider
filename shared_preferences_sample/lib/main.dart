...
void main() => runApp(ChangeNotifierProvider<ThemeColorData>(create: (context) => ThemeColorData(),child: MyApp()));

class MyApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    Provider.of<ThemeColorData>(context,listen: false).loadThemeFromSharedPreferences();
